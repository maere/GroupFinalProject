...
CREATE TABLE IF NOT EXISTS `posts`(
	...
	`user_id_created_by` int(11) NULL, 
	`user_id_last_update` int(11) NULL, 
    PRIMARY KEY (`post_id`),
...
ALTER TABLE `posts`
	...
	ALTER TABLE `user_role_bridge`
	ADD CONSTRAINT `user_role_idfk_1` FOREIGN KEY (`user_id`) REFERENCES
	`users`(`user_id`) ON DELETE NO ACTION,
	ADD CONSTRAINT `user_role_idfk_2` FOREIGN KEY (`role_id`) REFERENCES
...
INSERT INTO `user_role_bridge`(`role_id`, `user_id`) VALUES (2,1), (1,1);
-- no contraint needed for user_role bridge bc is established
-- ALTER TABLE `user_role_bridge`
