...
function fillPosts(allPostsList, status)
{
    ...
    {
        $('#contentRows').append($('<div>').attr({class: "row"}).append($('<div>').attr({ class: "col-lg-8 col-md-8 col-sm-8"}).append($('<h4>') //title
                ...
                .append($('<div>').attr({ //holds picture and post shorcut with link
                class: "row"
                })
                        //img div
