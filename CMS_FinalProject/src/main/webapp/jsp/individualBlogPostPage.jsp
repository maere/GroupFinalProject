            ...
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="container">
                    <div class="row">
                          ...
                          ${pageContext.request.contextPath}/${blogPost.postTitle}
                        ...
                        <div class="col-lg-8 col-md-8 col-sm-8">
                            ...
                            <a id="post-title" href="${pageContext.request.contextPath}/${blogPost.postTitle}"><h2>${blogPost.postTitle}</h2></a>
                            ...
                            <span id="post-content">${blogPost.content}</span>
